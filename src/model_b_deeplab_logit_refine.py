...
class LogitRefineHead(nn.Module):
    """
    Tiny refinement head on class logits.
    Uses depthwise + pointwise conv and residual add to smooth noisy boundaries
    ...
    def __init__(self, num_classes):
        ...
        self.pointwise = nn.Conv2d(num_classes, num_classes, kernel_size=1, bias=True)

    def forward(self, logits):
        return logits + self.pointwise(self.depthwise(logits))
...
class LightDeepLab(nn.Module):
    ...
    def __init__(self, in_ch=3, num_classes=19, base_ch=32):
        ...
        self.logit_refine = LogitRefineHead(num_classes)
